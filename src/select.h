...
int ncot_poll_init(struct ncot_context *context, struct ssh_event_struct *event);
int ncot_poll_prepare(struct ncot_context *context, struct ssh_event_struct *event);
